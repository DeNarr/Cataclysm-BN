...
void mutation_branch::load( const JsonObject &jo, const std::string & )
{
    ...
    optional( jo, was_loaded, "casting_time_multiplier", casting_time_multiplier, 1.0f);
    optional( jo, was_loaded, "spell_duration_multiplier", spell_duration_multiplier, 1.0f);
    optional( jo, was_loaded, "energy_cost_multiplier", energy_cost_multiplier, 1.0f);
