...
mutation_value_map = {
    ...
    { "spell_duration_multiplier", calc_mutation_value_multiplicative<&mutation_branch::spell_duration_multiplier> },
    { "energy_cost_multiplier", calc_mutation_value_multiplicative<&mutation_branch::energy_cost_multiplier> },
